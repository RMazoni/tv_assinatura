...
class AdditionalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create additional" do
    assert_difference("Additional.count") do
      post additionals_url, params: { additional: { name: @additional.name, price: @additional.price } }
    end
  ...
  test "should update additional" do
    patch additional_url(@additional), params: { additional: { name: @additional.name, price: @additional.price } }
